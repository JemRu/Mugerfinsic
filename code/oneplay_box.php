...
<html>
	<head>
        ...
        <script src="js/selectCookie.js" type="text/javascript" charset="utf-8"></script>
        <script src="js/setplayer.js" type="text/javascript" charset="utf-8"></script>
        ...
        <script type="text/javascript" src="js/solo_Event.js" ></script>
        <script src="js/bayinqin_shibie.js"></script>
	...
	<body>
		...
		<div class="middle">
			<div class="userbox">
				<div class="userpic">
					<img src="img/play/createpic.png">
				</div>
				<div class="userdescribe">
					<div id="player" class="userfont">
						
					</div>
				</div>
				<div class="userReady" id="myself"></div>				
			</div>
		</div>
		...
		<script>
			...
			var Name = getName();
			var Number = 1;
			console.log("getsoloData is run");
			setInterval(function(){
				$.ajax({
					url:"interface/soloData.php",
					type:"POST",
					data:{
						name:Name,
						num:Number
